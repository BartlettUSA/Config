...
## Inputs
Use the user's message as the GitHub issue number or URL.
...
1. Create feature branch: `fix/<issue-number>-<short-desc>`
...
### Phase 4: Completion
1. Commit changes with message referencing issue
